...
class TurkeyTrotPage(Page):
    ...
    title_override = models.CharField(
        max_length=255, blank=True, help_text="Override the page title displayed on the page"
    )
    ...
    event_date = models.DateTimeField(blank=True, null=True, help_text="Date and time of the event")
    event_location = models.CharField(max_length=255, blank=True, help_text="Event location")
    event_address = models.TextField(blank=True, help_text="Full event address")
    ...
    about_event = RichTextField(blank=True, help_text="About the event description")

    # Route section
    route_description = RichTextField(blank=True, help_text="Description of the race route")
    ...
    # Sponsor section
    sponsor_description = RichTextField(blank=True, help_text="Description for sponsors section")
            ...
            (
                ...
                blocks.StructBlock(
                    [
                        ...
                        (
                            "sponsors",
                            blocks.ListBlock(SponsorBlock(), help_text="Sponsors at this level"),
                        ),
                    ]
                ),
            )
    ...
    # About us section
    about_us = RichTextField(blank=True, help_text="About the organization")
    ...
    library_images = StreamField(
        [
            (
                "library_image",
                blocks.StructBlock(
                    [("image", ImageChooserBlock()), ("caption", blocks.TextBlock(required=False))]
                ),
            )
        ],
        blank=True,
